...
the corrected Defjam first-stage unpacker range has 139; Deuteros's clean
...
| Millennium Amiga | Motorola 68000 | corrected ADF transfers and `$41000..$411d7` two-exception unpacker span | F-line `$41110` exception entry and transformed continuation |
...
`0x1d8`, at `$41000`; two typed exceptions reach the first transformed branch
and stop at the F-line word `$41110`.
