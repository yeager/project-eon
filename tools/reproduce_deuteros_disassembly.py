...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        index = {
            ...
            "reports": [identity(amiga), identity(atari)],
            "mapped_source_bytes": {"amiga": 467456, "atari_st": 4608},
            "gaps": [
                "Atari ST stages after the mapped 0x1200-byte first stage have no proven load map",
