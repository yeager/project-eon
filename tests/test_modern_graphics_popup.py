...
class ModernGraphicsPopupTests(unittest.TestCase):
    ...
    def test_diagnostics_reject_forged_release_metadata_before_map_composition(self) -> None:
        ...
        self.assertIn("millennium_dos_external_requirement", SOURCE)
        self.assertIn("diagnostics.millennium_dos_external_requirement", popup)
        self.assertIn("millennium_dos_external_requirement_summary", SOURCE)
        self.assertIn("WAIT=", SOURCE)
        self.assertIn("deuteros_amiga_external_requirement", SOURCE)
        self.assertIn("diagnostics.deuteros_amiga_external_requirement", popup)
        self.assertIn("deuteros_amiga_external_requirement_summary", SOURCE)
        self.assertIn("DeuterosAmigaSessionStopReason::external_observation", SOURCE)
        ...
        self.assertIn("runtime.deuteros_amiga_opening_checkpoint()", SOURCE)
        self.assertIn("deuteros_amiga_opening_checkpoint", SOURCE)
        self.assertIn("diagnostics.deuteros_amiga_opening_checkpoint", popup)
        self.assertIn('"OPENING T="', SOURCE)
