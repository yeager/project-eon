...
bool validate_deuteros_amiga_title_display_reference_events(
    ...
    for (std::size_t at = display_start; at < events.size();) {
        ...
        if (step == Step::display && type == "display-layout" && exact(fields, {"site", "base_source_address", "base_destination_a", "base_destination_b", "display_base", "display_list", "copper_list_sha256"})
            ...
            && fields.at("display_base") == "0x0000ab00" && hex(fields.at("rgba_width"), 4) && hex(fields.at("rgba_height"), 4) && fields.at("bitplanes_sha256") == "fad588ff5f6e0ec471cb4889987dab4a40c11d7da6e532564d48475149c68490" && sha(fields.at("rgba_sha256"))) { accepted = true; step = Step::audio; ++diagnostics.frame_checkpoint_count; }
