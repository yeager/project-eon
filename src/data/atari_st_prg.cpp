...
MillenniumAtariConfigEntry parse_millennium_atari_config_entry(
    ...
    constexpr ExecutableByteAnchor<128> entry_bytes{"ac3fed97651f8ec299c59dbb9de7e92412e387467c7832e718232a2339ff7cab"};
    ...
    if (payload.size() < 6 || read_be16(payload, 0) != 0x4ef9U
        ...
        || !entry_bytes.matches(payload.subspan(entry_offset, entry_bytes.size()))) {
