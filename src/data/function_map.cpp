...
constexpr std::array<FunctionMapEntry, 57> entries{{
    ...
    {"millennium-atari-en-fclose-to-game-init", "ba1174123a0531abeab5788f4ac87a3c2500696bf1c87a7efd209441b3ebdf01",
     ...
     "the source byte at $2c250 and continuation from $2b2de remain unproven",
     "native typed Fclose through game-init setup", "PRESERVATION.md#millennium-atari-st-relocation-evidence",
     "3f090651ee586cf32a3f37f41b748ba36c78799e7bf761b66ddca2352579afe7"},
    ...
    {"deuteros-amiga-en-title-post-command-service-prefix", "f4dc8dd1c27c5d389837783becd9b95ab09b78baf40e94e39e2b7e590e470e04",
     ...
     "the mutable $20a10 byte before selector $004b remains a typed boundary",
     "native selector-5c descriptor-bit loop complete", "PRESERVATION.md#deuteros-amiga-title-input-and-bootstrap-handoff",
     "48d65260e9b5f5cbf8d8b3675a178c81b8764810b61a6a2539a56dcb40a8de03"},
