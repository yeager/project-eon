...
constexpr std::array<FunctionMapEntry, 103> entries{{
    ...
    {"millennium-amiga-en-first-stage-entry", "ec0424445d494809d2661492e289af71b056a429dde13b053a472ccc8347d4dd",
     ...
     "the internal setup call $415ea at $4252e remains external",
     "native typed Exec transition through $4252e", "PRESERVATION.md#millennium-amiga-raw-loader-evidence",
    ...
    {"millennium-dos-en-f6-handler", "e6e7044b25877fdf8b10d16d2f395886d9957953144ae15ca630cda9cab2a123",
     ...
     "the predecessor that enters $74c1 and later helper semantics remain unproven; exact restoration SHA-256 990dfec0e40229d70d100b1e6d4174f069eed46f95dacbc1d958334314a68525; caller SHA-256 26aa10af6fc9d62f91ab8e1f922622618d61b0f92af3b48e641e8a5ee400a76c; $cc4e..$cd9c SHA-256 2b0d73e35b2e49332d559b32128c425b08a983731e6ba8bc30e33c0dca2a88c4; $4241/$cc23 result sources and $cbc0 behavior remain unknown",
     "native F6 and $cc4e helper through the 18-entry table and second $cbc0 boundary", "PRESERVATION.md#main-loop-action-dispatch",
     "427574e5f780b2a7b5c4207d167116dc44aea3fb67096fbf12a46c4f544a0a57"},
    ...
    {"deuteros-amiga-en-main-20994-exec-entry", "f4dc8dd1c27c5d389837783becd9b95ab09b78baf40e94e39e2b7e590e470e04",
     ...
     "typed vectors and the $22a5a result remain without semantics; nonzero -$1bc result enters the exact $209fa spin; zero requires the prior CIA-A $bfe001 byte and owned $21704 word, atomically sets bit 1 and mirrors the word at $21704/$21706; continuation SHA-256 cb9046ad20fffc0a52f43431949927b4d159ecc795fe5f62dbbd01accd0684c7",
     "native local entry through typed third Exec branches and CIA-A bit set", "PRESERVATION.md#deuteros-amiga-execution-chain",
     "a82c0d6a12e156e0832d632a6c40dd58713a00b611dbcba7289aa16b0969a0a6"},
