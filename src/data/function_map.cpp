...
constexpr std::array<FunctionMapEntry, 103> entries{{
    ...
    {"millennium-amiga-en-first-stage-entry", "ec0424445d494809d2661492e289af71b056a429dde13b053a472ccc8347d4dd",
     ...
     "the Exec allocation vector -198 at $4164a remains external",
     "native typed graphics-library open through $4164a", "PRESERVATION.md#millennium-amiga-raw-loader-evidence",
    ...
    {"millennium-dos-en-f6-handler", "e6e7044b25877fdf8b10d16d2f395886d9957953144ae15ca630cda9cab2a123",
     "millennium-dos-game-flow", Game::millennium, Platform::dos, "en", "i8086",
     "427574e5f780b2a7b5c4207d167116dc44aea3fb67096fbf12a46c4f544a0a57",
     "2200AD.EXE+0x7315, +0x73c1, and +0xcb4e", "$7415", "verified-static",
     "the predecessor that enters $74c1 and later helper semantics remain unproven; exact restoration SHA-256 990dfec0e40229d70d100b1e6d4174f069eed46f95dacbc1d958334314a68525; caller SHA-256 26aa10af6fc9d62f91ab8e1f922622618d61b0f92af3b48e641e8a5ee400a76c; $cc4e..$ce0d SHA-256 8928e3ce8385e3d766c753905a357bd17c627c861006e492b5b702866fce4592; $4241/$cc23 result sources and callee behavior remain unknown",
     "native F6 and $cc4e helper through the 38-entry walk and $4f08 boundary", "PRESERVATION.md#main-loop-action-dispatch",
     "427574e5f780b2a7b5c4207d167116dc44aea3fb67096fbf12a46c4f544a0a57"},
    ...
    {"deuteros-amiga-en-main-20994-exec-entry", "f4dc8dd1c27c5d389837783becd9b95ab09b78baf40e94e39e2b7e590e470e04",
     ...
     "typed vectors and local-service results remain without semantics; nonzero -$1bc enters the exact $209fa spin; the zero path reaches typed $22a5a, $21276, and $21380 returns, atomically clears $21720/$2171e and sets $210f2, then stops before the hash-bound $dff016 bit-10 probe; loop span SHA-256 5f6f98a368159e3d6415d3be5f1cdf38d38495f55b5ca6b5b212d36dcb9dc732",
     "native local entry through first main-loop scheduler return", "PRESERVATION.md#deuteros-amiga-execution-chain",
     "a82c0d6a12e156e0832d632a6c40dd58713a00b611dbcba7289aa16b0969a0a6"},
