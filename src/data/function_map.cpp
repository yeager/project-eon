...
constexpr std::array<FunctionMapEntry, 102> entries{{
    ...
    {"millennium-amiga-en-first-stage-entry", "ec0424445d494809d2661492e289af71b056a429dde13b053a472ccc8347d4dd",
     ...
     "the first transformed F-line exception and continuation remain unproven",
     "native two-exception unpacker prefix through transformed branch to $41110", "PRESERVATION.md#millennium-amiga-raw-loader-evidence",
    ...
    {"deuteros-amiga-en-main-entry", "f4dc8dd1c27c5d389837783becd9b95ab09b78baf40e94e39e2b7e590e470e04",
     ...
     "incoming D0 and the first Exec result are typed without semantics; the second Exec -$9c return, graphics ABI, input, timing, and game state remain unproven",
     "native caller-connected re-entry through second Exec boundary", "PRESERVATION.md#deuteros-amiga-execution-chain",
