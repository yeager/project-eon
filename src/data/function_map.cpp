...
constexpr std::array<FunctionMapEntry, 103> entries{{
    ...
    {"millennium-amiga-en-first-stage-entry", "ec0424445d494809d2661492e289af71b056a429dde13b053a472ccc8347d4dd",
     ...
     "the Exec vector -150 call at $4251a remains external",
     "native typed hardware/ExecBase prefix through $4251a", "PRESERVATION.md#millennium-amiga-raw-loader-evidence",
    ...
    {"millennium-dos-en-f6-handler", "e6e7044b25877fdf8b10d16d2f395886d9957953144ae15ca630cda9cab2a123",
     ...
     "the predecessor that enters $74c1 and later helper semantics remain unproven; exact restoration SHA-256 990dfec0e40229d70d100b1e6d4174f069eed46f95dacbc1d958334314a68525; caller SHA-256 26aa10af6fc9d62f91ab8e1f922622618d61b0f92af3b48e641e8a5ee400a76c; $cc4e..$cd62 SHA-256 4a397c5288f1b47472c1a73a386c2a1ea6843008316a96236b58f90321aa0e59; $4241 result source and $cbc0 behavior remain unknown",
     "native F6 and $cc4e helper through two typed AL results and $cbc0 boundary", "PRESERVATION.md#main-loop-action-dispatch",
     "427574e5f780b2a7b5c4207d167116dc44aea3fb67096fbf12a46c4f544a0a57"},
    ...
    {"deuteros-amiga-en-main-20994-exec-entry", "f4dc8dd1c27c5d389837783becd9b95ab09b78baf40e94e39e2b7e590e470e04",
     ...
     "typed vectors remain without semantics; nonzero -$1bc result enters the exact $209fa spin; zero result reaches the unexecuted $217e4 bit-set boundary; zero continuation SHA-256 93b5af841a21c4972e899f8112960b10e7cf6d702e7bd7bf1e29351ceac66c8f and caller prefix SHA-256 bddd50234d5142a95cb582e1829eb49a00a79ff2f3307f8af4de8f880994e3f9",
     "native local entry through typed third Exec return branches", "PRESERVATION.md#deuteros-amiga-execution-chain",
     "a82c0d6a12e156e0832d632a6c40dd58713a00b611dbcba7289aa16b0969a0a6"},
