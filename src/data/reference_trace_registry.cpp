...
constexpr std::array<ReferenceTraceAdapterDescriptor, 11> registry{{
    ...
    {"millennium-dos-en-title-handoff-v3", "project-eon-reference-trace-v3", Game::millennium, Platform::dos, "en", "e6e7044b25877fdf8b10d16d2f395886d9957953144ae15ca630cda9cab2a123", "", "", ReferenceTraceRuntimePolicy::transient_title_handoff, {"millennium-dos-title-flow", "millennium-dos-game-flow", ""}, 2},
    ...
    {"millennium-amiga-en-defjam-bootstrap-v1", "project-eon-reference-trace-v2", Game::millennium, Platform::amiga, "en", "2e27d7aeb8b8b7f2a75eda45b456ab42775a706aa85516c85e61ce94ec9eb400", "", "", ReferenceTraceRuntimePolicy::diagnostics_only, {"millennium-amiga-defjam-bootstrap", "millennium-amiga-defjam-first-stage-entry", ""}, 2},
...
std::string_view reference_trace_runtime_policy_label(const ReferenceTraceRuntimePolicy policy) {
    ...
    case ReferenceTraceRuntimePolicy::transient_title_handoff:
        return "transient-title-handoff";
