...
constexpr std::array<ReferenceTraceAdapterDescriptor, 11> registry{{
    ...
    {"millennium-dos-en-title-handoff-v3", "project-eon-reference-trace-v3", Game::millennium, Platform::dos, "en", "e6e7044b25877fdf8b10d16d2f395886d9957953144ae15ca630cda9cab2a123", "", "", ReferenceTraceRuntimePolicy::diagnostics_only, {"millennium-dos-title-flow", "millennium-dos-game-flow", ""}, 2},
