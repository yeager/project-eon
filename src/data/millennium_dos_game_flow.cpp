...
MillenniumDosGameFlow parse_millennium_dos_game_flow(
    ...
    constexpr ExecutableByteAnchor<65> startup{"6567180153535f0881e848aeda561f324ee48f1d9c6873265f77d7974fd64491"};
...
MillenniumDosPostOverlayAdapterLoop parse_millennium_dos_post_overlay_adapter_loop(
    ...
    constexpr ExecutableByteAnchor<69> loop_anchor{"1bbb4fcc18668021306de1e0014a9baab1f526af1514fa7ce9d1a61780972cf0"};
    ...
    if (game_executable.size() != 54'391
        || to_hex(sha256(game_executable)) != executable_sha256) {
        throw std::runtime_error("Unsupported Millennium DOS post-overlay-adapter executable");
    }
    const auto loop = game_executable.subspan(offset(entry), loop_anchor.size());
    if (!loop_anchor.matches(loop)
        ...
        || to_hex(sha256(loop)) != loop_sha256) {
...
parse_millennium_dos_gx_overlay_dispatch13_evidence(
    ...
    constexpr ExecutableByteAnchor<148> span{"afd0e53d6588f8576da75c48155d63b8f1b2380f02c9d2adfc65a27e78e25ee0"};
...
parse_millennium_dos_spanish_game_startup_evidence(const std::span<const std::uint8_t> game_executable) {
    ...
    if (game_executable.size() != 54'566 || to_hex(sha256(game_executable)) != executable_sha256
        ...
        throw std::runtime_error("Unexpected Millennium Spanish DOS game executable");
    }
    ...
    if (!startup_anchor.matches(startup)
        ...
        || to_hex(sha256(startup)) != startup_sha256) {
