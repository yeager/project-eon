...
public:
    ...
    [[nodiscard]] auto advance_main_stage_disk_transition(const DeuterosAmigaOwnedDiskTransitionPlan&plan) { return service_batch_boundary_session_.advance_main_stage_disk_transition(plan); }
    [[nodiscard]] auto advance_main_stage_auxiliary_local_path(const DeuterosAmigaMainStageLoopGraphicsPlan&plan) { return service_batch_boundary_session_.advance_main_stage_auxiliary_local_path(plan); }
    ...
    [[nodiscard]] std::optional<DeuterosAmigaMainStageResourceLoadPlan> observe_main_stage_resource_load(const DeuterosAmigaObservedMainStageResourceLoad&o,std::uint32_t restart_d0=0) { return service_batch_boundary_session_.observe_main_stage_resource_load(o,restart_d0); }
