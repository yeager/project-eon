...
enum class MillenniumDosTitleInitializationState {
    ...
    post_descriptor_first_loop_mode_two_header_word_boundary,
    post_descriptor_first_loop_mode_two_source_byte_boundary,
    ...
    post_descriptor_next_loop_stream_byte_boundary,
...
struct MillenniumDosTitleDescriptorStreamDriveResult {
    bool accepted = false;
...
public:
    ...
    [[nodiscard]] MillenniumDosTitleDescriptorStreamDriveResult
    drive_next_descriptor_stream_from_title_library(
        std::span<const std::uint8_t>, MillenniumDosTitleDescriptorStreamDriveRequest);
