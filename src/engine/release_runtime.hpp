...
struct DeuterosAmigaTitleDependencyChainCheckpoint {
    ...
    DeuterosAmigaMainStageState main_stage_state =
...
struct MillenniumAmigaFirstStageEntryObservation {
    std::uint64_t sequence=0;
    MillenniumAmigaFirstStageRegisterObservation registers;
};
struct MillenniumAmigaFirstStageIllegalHandlerObservation {
    std::uint64_t sequence=0;
    MillenniumAmigaFirstStageIllegalObservation exception;
};
struct MillenniumAmigaSecondIllegalHandlerObservation {
    std::uint64_t sequence=0;
...
struct MillenniumDosSixthFunctionAlObservation {
    std::uint16_t instruction_address = 0;
    std::uint8_t value = 0;
};
...
struct MillenniumDosSixthFunctionCheckpoint {
    ...
    std::optional<MillenniumDosSixthFunctionStateClearEffect>
        caller_helper_state_clear_effect;
    std::vector<MillenniumDosSixthFunctionBulkEffect> caller_helper_bulk_effects;
};
...
public:
    ...
    [[nodiscard]] DeuterosAmigaMainStageFrame
        deuteros_amiga_main_stage_frame() const;
    ...
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult observe_deuteros_amiga_main_stage_reentry_d0(DeuterosAmigaObservedMainStageReentryD0);
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult observe_deuteros_amiga_main_stage_first_exec_return(DeuterosAmigaObservedMainStageExecReturn);
    ...
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult observe_deuteros_amiga_main_stage_resource_load(DeuterosAmigaObservedMainStageResourceLoad);
    ...
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult observe_deuteros_amiga_view_wait(DeuterosAmigaObservedViewWait);
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult advance_deuteros_amiga_command_palette();
    ...
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult observe_deuteros_amiga_frame_buffer(DeuterosAmigaObservedFrameBuffer);
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult advance_deuteros_amiga_main_stage_scheduler_pass();
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult advance_deuteros_amiga_main_stage_record_loop();
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult observe_deuteros_amiga_loop_request_service(DeuterosAmigaObservedLoopRequestService);
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult observe_deuteros_amiga_optional_resource_cia(DeuterosAmigaObservedOptionalResourceCia);
    [[nodiscard]] DeuterosAmigaTitleDependencyObservationResult observe_deuteros_amiga_main_stage_loop_graphics_return(DeuterosAmigaObservedMainStageExecReturn);
    ...
    [[nodiscard]] MillenniumDosSixthFunctionObservationResult
    observe_millennium_dos_sixth_function_al(MillenniumDosSixthFunctionAlObservation observation);
    [[nodiscard]] MillenniumDosSixthFunctionObservationResult begin_millennium_dos_sixth_function_restoration();
    [[nodiscard]] MillenniumDosSixthFunctionObservationResult begin_millennium_dos_sixth_function_caller_helper_prefix();
...
private:
    ...
    std::optional<std::uint64_t> millennium_amiga_setup_return_sequence_;
    std::optional<std::uint64_t> millennium_amiga_first_read_return_sequence_;
    ...
    std::optional<std::array<std::uint16_t,16>> deuteros_amiga_main_stage_palette_;
    std::optional<DeuterosAmigaMainStageFrameSnapshot> deuteros_amiga_pending_main_stage_frame_;
