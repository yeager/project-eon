...
MillenniumAtariConfigConsumerResult MillenniumAtariConfigConsumerSession::observe_game_init_palette_xbios_selector_6(const MillenniumAtariGameInitPaletteXbios6Observation&o){if(checkpoint_.state!=MillenniumAtariConfigConsumerState::game_init_palette_xbios_selector_6_boundary)return{false,"Palette XBIOS selector-6 result is unavailable"};if(o.generation!=checkpoint_.generation||o.sequence<=checkpoint_.last_sequence||o.trap_address!=0x2b4ac||o.selector!=6)return{false,"Palette XBIOS selector-6 observation mismatch"};auto next=checkpoint_;next.state=MillenniumAtariConfigConsumerState::game_init_palette_outer_recurrence_boundary;next.last_sequence=o.sequence;next.game_init_palette_xbios_result_observed=true;next.game_init_palette_xbios_result_d0=o.result_d0;next.game_init_palette_xbios_stack_cleanup_bytes=6;next.game_init_palette_post_xbios_sha256="9e3fd4aeca606c5560b204d12a20a77de12552ded7fa64a0677cca56c4676bf1";next.game_init_palette_delay_initial_d0=0x4e20;next.game_init_palette_delay_iterations=0x4e20;next.game_init_palette_delay_final_d0=0;next.game_init_d7=static_cast<std::uint16_t>(next.game_init_d7-1U);next.game_init_palette_outer_backedge_address=0x2b44c;next.game_init_next_instruction=0x2b44c;next.local_instruction_count+=40003U;checkpoint_=std::move(next);return{true,{}};}
