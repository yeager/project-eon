...
std::optional<MillenniumDosCompatibilityRunnerCheckpoint> NativeSessionController::tick_millennium_dos_compatibility_runner(){if(state_!=NativeSessionState::millennium_dos_sound_driver_boundary&&state_!=NativeSessionState::millennium_dos_title)return std::nullopt;auto result=runtime_.tick_millennium_dos_compatibility_runner();synchronize_after_runtime_change();return result;}
MillenniumDosSessionDriveResult NativeSessionController::drive_millennium_dos_session(const std::uint32_t step_limit){if(state_!=NativeSessionState::millennium_dos_sound_driver_boundary&&state_!=NativeSessionState::millennium_dos_title)return {false,0,MillenniumDosSessionStopReason::inactive,{},{},0,"Millennium deterministic session drive requires an active DOS boundary"};auto result=runtime_.drive_millennium_dos_session(step_limit);synchronize_after_runtime_change();return result;}
...
MillenniumDosTitleInitializationObservationResult NativeSessionController::observe_millennium_dos_title_continuation(MillenniumDosTitleContinuationObservation o){if(state_!=NativeSessionState::millennium_dos_title)return {false,"Title continuation requires the active title boundary"};return runtime_.observe_millennium_dos_title_continuation(std::move(o));}
...
EON_NATIVE_SIXTH_PROXY(observe_millennium_dos_sixth_function_al, MillenniumDosSixthFunctionAlObservation)
#undef EON_NATIVE_SIXTH_PROXY
MillenniumDosSixthFunctionObservationResult NativeSessionController::begin_millennium_dos_sixth_function_restoration(){if(state_!=NativeSessionState::millennium_dos_sixth_function)return{false,"Restoration requires the sixth-function session"};return runtime_.begin_millennium_dos_sixth_function_restoration();}
MillenniumDosSixthFunctionObservationResult NativeSessionController::begin_millennium_dos_sixth_function_caller_helper_prefix(){if(state_!=NativeSessionState::millennium_dos_sixth_function)return{false,"Caller-helper prefix requires the sixth-function session"};return runtime_.begin_millennium_dos_sixth_function_caller_helper_prefix();}
...
NativeSessionController::drive_deuteros_amiga_session(const std::uint32_t step_limit) {
    auto result=runtime_.drive_deuteros_amiga_session(step_limit);
    synchronize_after_runtime_change();
    return result;
}
...
EON_NATIVE_DEUTEROS_TITLE(advance_deuteros_amiga_title_tail_subroutine,(),())
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_title_tail_initial_service_return,(const DeuterosAmigaObservedLocalCallReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_title_tail_exec_return,(const DeuterosAmigaObservedTitleTailExecReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_title_tail_compare_longs,(const DeuterosAmigaObservedTitleTailCompareLongs o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_title_tail_controller_long,(const DeuterosAmigaObservedTitleTailControllerLong o),(o))
EON_NATIVE_DEUTEROS_TITLE(advance_deuteros_amiga_title_profile_two_bootstrap,(),())
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_reentry_d0,(const DeuterosAmigaObservedMainStageReentryD0 o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_first_exec_return,(const DeuterosAmigaObservedMainStageExecReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_second_exec_return,(const DeuterosAmigaObservedMainStageExecReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_first_local_return,(const DeuterosAmigaObservedLocalCallReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_pointer_service_return,(const DeuterosAmigaObservedMainStagePointerServiceReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_audio_setup,(const DeuterosAmigaObservedMainStageAudioSetup o),(o))
EON_NATIVE_DEUTEROS_TITLE(advance_deuteros_amiga_main_stage_20994_exec_entry,(),())
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_2099e_exec_return,(const DeuterosAmigaObservedMainStageExecReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_209ca_exec_return,(const DeuterosAmigaObservedMainStageExecReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_209f0_exec_return,(const DeuterosAmigaObservedMainStageExecReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_cia_a_bit_set,(const DeuterosAmigaObservedMainStageCiaABitSet o),(o))
...
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_view_wait,(const DeuterosAmigaObservedViewWait o),(o))
EON_NATIVE_DEUTEROS_TITLE(advance_deuteros_amiga_command_palette,(),())
EON_NATIVE_DEUTEROS_TITLE(advance_deuteros_amiga_fade_buffers,(),())
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_outer_counter,(const DeuterosAmigaObservedOuterCounter o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_outer_service,(const DeuterosAmigaObservedLoopRequestService o),(o))
EON_NATIVE_DEUTEROS_TITLE(begin_deuteros_amiga_disk_transition,(const AmigaDiskKind disk),(disk))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_disk_transition_palette_return,(const DeuterosAmigaObservedDiskTransitionPaletteReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_disk_transition_input,(const DeuterosAmigaObservedDiskTransitionInput o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_outer_input,(const DeuterosAmigaObservedOuterInput o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_command_palette_return,(const DeuterosAmigaObservedMainStageExecReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(advance_deuteros_amiga_view_selection,(),())
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_frame_buffer,(const DeuterosAmigaObservedFrameBuffer o),(o))
...
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_optional_resource_cia,(const DeuterosAmigaObservedOptionalResourceCia o),(o))
...
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_loop_prepare_return,(const DeuterosAmigaObservedLocalCallReturn o),(o))
EON_NATIVE_DEUTEROS_TITLE(observe_deuteros_amiga_main_stage_loop_scheduler_return,(const DeuterosAmigaObservedLocalCallReturn o),(o))
...
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_first_stage_entry(const MillenniumAmigaFirstStageEntryObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"First-stage entry requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_first_stage_entry(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_first_stage_illegal_handler(const MillenniumAmigaFirstStageIllegalHandlerObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"First-stage ILLEGAL handler requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_first_stage_illegal_handler(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_second_illegal_handler(const MillenniumAmigaSecondIllegalHandlerObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"Second ILLEGAL handler requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_second_illegal_handler(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_first_trace_handler(const MillenniumAmigaFirstTraceHandlerObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"First trace handler requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_first_trace_handler(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_trace_branch_chain(const MillenniumAmigaTraceBranchChainRuntimeObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"Trace branch chain requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_trace_branch_chain(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_trace_register_prefix(const MillenniumAmigaTraceRegisterPrefixRuntimeObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"Trace register prefix requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_trace_register_prefix(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_bus_error_prefix(const MillenniumAmigaBusErrorRuntimeObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"Bus-error prefix requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_bus_error_prefix(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_custom_chip_exec_prefix(const MillenniumAmigaCustomChipExecRuntimeObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"Custom-chip/ExecBase prefix requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_custom_chip_exec_prefix(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_exec_transition(const MillenniumAmigaExecTransitionRuntimeObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"Exec transition requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_exec_transition(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_open_graphics(const MillenniumAmigaOpenGraphicsRuntimeObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"Open-graphics service requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_open_graphics(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_allocation(const MillenniumAmigaAllocationRuntimeObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"Allocation requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_allocation(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_graphics_initialization(const MillenniumAmigaGraphicsInitializationRuntimeObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"Graphics initialization requires Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_graphics_initialization(o);}
MillenniumAmigaBootstrapRelocatorObservationResult NativeSessionController::observe_millennium_amiga_view_services(const MillenniumAmigaViewServiceRuntimeObservation o){if(state_!=NativeSessionState::millennium_amiga_bootstrap)return{false,"View services require Millennium Amiga bootstrap"};return runtime_.observe_millennium_amiga_view_services(o);}
