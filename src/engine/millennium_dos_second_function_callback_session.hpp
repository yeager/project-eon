...
#include <vector>
namespace eon {
enum class MillenniumDosSecondFunctionCallbackState { awaiting_selection_byte, external_reset_jump, awaiting_reset_first_call_return, awaiting_reset_second_call_return, awaiting_reset_third_call_return, awaiting_reset_fourth_call_return, awaiting_reset_fifth_call_return, reset_returned, awaiting_record_pointer, awaiting_first_call_return, awaiting_second_call_return, awaiting_wait_return, awaiting_wait_bl, awaiting_third_call_return, awaiting_fourth_call_return, external_tail_jump };
enum class MillenniumDosSecondFunctionCallbackBoundaryKind { runtime_byte, runtime_word, call_return, register_bl, external_jump, local_return };
...
public:
 ...
 void observe_external_jump_entry(std::uint16_t instruction_address,std::uint16_t target_address);
