...
public:
    ...
    [[nodiscard]] std::optional<DeuterosAmigaMainStageResourceLoadPlan> observe_main_stage_resource_load(const DeuterosAmigaObservedMainStageResourceLoad&o) { return title_stage_session_ ? title_stage_session_->observe_main_stage_resource_load(o) : std::nullopt; }
    [[nodiscard]] std::optional<DeuterosAmigaMainResourceTransfer> main_resource_transfer(const std::uint16_t index) const { return read_deuteros_amiga_main_resource(disk_,load_plan_,index); }
    ...
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopPrepareBodyPlan> advance_main_stage_loop_prepare_body(const std::uint32_t a1=0,const std::uint32_t a6=0) { return title_stage_session_ ? title_stage_session_->advance_main_stage_loop_prepare_body(a1,a6) : std::nullopt; }
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> observe_main_stage_outer_input(const DeuterosAmigaObservedOuterInput&o,DeuterosAmigaOuterInputRoute route) { return title_stage_session_ ? title_stage_session_->observe_main_stage_outer_input(o,route) : std::nullopt; }
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> advance_main_stage_command_palette(std::uint32_t palette,std::uint32_t library) { return title_stage_session_ ? title_stage_session_->advance_main_stage_command_palette(palette,library) : std::nullopt; }
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> observe_main_stage_command_palette_return(const DeuterosAmigaObservedMainStageExecReturn&o,std::uint32_t library) { return title_stage_session_ ? title_stage_session_->observe_main_stage_command_palette_return(o,library) : std::nullopt; }
    ...
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> advance_main_stage_view_selection(std::uint16_t counter,std::uint32_t a6) { return title_stage_session_ ? title_stage_session_->advance_main_stage_view_selection(counter,a6) : std::nullopt; }
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> advance_main_stage_frame_buffer(const DeuterosAmigaObservedFrameBuffer&o,std::uint16_t counter) { return title_stage_session_ ? title_stage_session_->advance_main_stage_frame_buffer(o,counter) : std::nullopt; }
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> advance_main_stage_scheduler_pass(std::optional<DeuterosAmigaOwnedCommandStop> stop=std::nullopt) { return title_stage_session_ ? title_stage_session_->advance_main_stage_scheduler_pass(stop) : std::nullopt; }
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> advance_main_stage_record_loop(std::uint32_t a0=0,std::uint32_t a1=0,std::uint32_t d0=0) { return title_stage_session_ ? title_stage_session_->advance_main_stage_record_loop(a0,a1,d0) : std::nullopt; }
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> advance_main_stage_loop_request_return(const DeuterosAmigaObservedLoopRequestService&o,std::uint32_t pointer) { return title_stage_session_ ? title_stage_session_->advance_main_stage_loop_request_return(o,pointer) : std::nullopt; }
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> advance_main_stage_loop_graphics_return(const DeuterosAmigaObservedMainStageExecReturn&o,std::uint32_t a1,std::uint32_t a6) { return title_stage_session_ ? title_stage_session_->advance_main_stage_loop_graphics_return(o,a1,a6) : std::nullopt; }
