...
public:
    ...
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> advance_main_stage_scheduler_pass() { return title_stage_session_ ? title_stage_session_->advance_main_stage_scheduler_pass() : std::nullopt; }
