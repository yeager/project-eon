...
public:
    ...
    [[nodiscard]] std::optional<DeuterosAmigaMainStageLoopGraphicsPlan> advance_main_stage_fade_buffers(std::uint32_t final_a0) { return title_stage_session_ ? title_stage_session_->advance_main_stage_fade_buffers(final_a0) : std::nullopt; }
