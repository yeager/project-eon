...
#include <vector>
namespace eon {
enum class MillenniumDosBdfOtherModeState { awaiting_toggle, awaiting_segment, awaiting_source_word, awaiting_nonzero_segment, awaiting_nonzero_copy_far_word, awaiting_nonzero_transform_flag, awaiting_nonzero_mask_word, awaiting_nonzero_mask_far_word, awaiting_nonzero_pattern_word, awaiting_mode_four_toggle, awaiting_mode_four_segment, awaiting_mode_four_source_word, awaiting_mode_four_source_byte, awaiting_mode_four_nonzero_segment, awaiting_mode_four_copy_far_word, awaiting_mode_four_copy_far_byte, awaiting_mode_four_transform_flag, awaiting_mode_four_mask_word, awaiting_mode_four_mask_far_word, awaiting_mode_four_mask_far_byte, awaiting_mode_four_pattern_word, returned };
...
private:
    static std::uint16_t byte_swap(std::uint16_t);static std::uint16_t rotate_right(std::uint16_t,std::uint8_t);void begin_transform_plane();void begin_nonzero_transform_plane();
