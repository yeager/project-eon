...
std::string_view runtime_session_kind_label(const RuntimeSessionKind kind) {
    ...
    case RuntimeSessionKind::millennium_dos_first_function:return "MILLENNIUM DOS FIRST-FUNCTION HANDLER";
    case RuntimeSessionKind::millennium_dos_second_function:return "MILLENNIUM DOS SECOND-FUNCTION HANDLER";
    case RuntimeSessionKind::millennium_dos_second_function_callback:return "MILLENNIUM DOS SECOND-FUNCTION CALLBACK";
