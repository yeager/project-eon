...
constexpr std::array<ReleaseRuntimeCapability, 8> capabilities{{
    ...
    // This image remains in the one-to-one manifest companion so hashes and
    // scanner diagnostics stay reproducible.  It deliberately has no native
    // runtime adapter: Spanish Millennium DOS is preservation-only scope.
    {"b40cc2f2c39cdb476b4a82bda7bffed1c80decdfb7fe41b1a38bf54343e0c0a4", Game::millennium, Platform::dos, "es", ReleaseRuntimeAdapter::preservation_only, PlatformCoverage::preservation_only, RuntimeSessionKind::millennium_dos_title, RuntimeSessionBoundary::recovered_presentation_boundary, {true, false, true}},
